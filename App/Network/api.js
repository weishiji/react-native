...
var STYLEWE_HOST = 'http://7.alpha.stylewe.com/rest/';
exports.LOGIN = STYLEWE_HOST + 'auth'
exports.PRODUCT_DETAIL = STYLEWE_HOST + 'product/';
exports.USER_ADDRESS = STYLEWE_HOST + 'address/'
exports.ORDER = STYLEWE_HOST + 'order/'